...
The second solution implements the ***peak calling*** function using the dREG scores based on the improved SVR model. Compared with the broad peaks in the first solution, this solution generates narrower peaks with peak score, probability, and center position.
